...
[https://dl.gitea.com/gitea/](https://dl.gitea.com/gitea/)
...
![](/images/2026-06-21-gitea-基本使用/001.png)

根据提示配置即可

![](/images/2026-06-21-gitea-基本使用/002.png)

此时点击立即安装页面会一直显示如下状态

![](/images/2026-06-21-gitea-基本使用/003.png)

这是由于修改了端口, 可以通过命令行查看是否安装成功. 安装成功后的命令行如下, 直接 `Ctrl+C` 结束即可

![](/images/2026-06-21-gitea-基本使用/004.png)
...
![](/images/2026-06-21-gitea-基本使用/005.png)

![](/images/2026-06-21-gitea-基本使用/006.png)

添加用户时, 建议取消勾选修改密码

![](/images/2026-06-21-gitea-基本使用/007.png)
...
`ci` 文件位于 `.gitea/workflows/ci.yaml` , 内容如下
...
在 [https://gitea.com/gitea/act_runner/releases](https://gitea.com/gitea/act_runner/releases) 下载最新稳定版. 此处以 `act_runner-0.2.13-linux-amd64.xz` 版本为例
...
![](/images/2026-06-21-gitea-基本使用/011.png)
...
![](/images/2026-06-21-gitea-基本使用/012.png)


执行效果

![](/images/2026-06-21-gitea-基本使用/013.png)
